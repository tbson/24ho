...
export class EmployerTable extends React.Component<Props, States> {
    nextUrl: ?string;
    prevUrl: ?string;
    ...
    render() {
        ...
        const modalTitle = formValues.id ? 'Update employer' : 'Add new employer';
        return (
            <div>
                ...
                <DefaultModal open={this.state.modal} title={modalTitle} handleClose={() => this.toggleModal('modal')}>
                    <EmployerForm formValues={formValues} formErrors={formErrors} groupList={groupList} handleSubmit={this.handleSubmit}>
