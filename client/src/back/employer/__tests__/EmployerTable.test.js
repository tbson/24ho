...
describe('EmployerTable component', () => {
    ...
    it('Init data', done => {
        const wrapper = shallow(<EmployerTable />);
    ...
    it('Check all', () => {
        ...
        jest.spyOn(EmployerTable.prototype, 'componentDidMount').mockImplementation(() => {});

        const wrapper = shallow(<EmployerTable list={seeding(10)} />);
        const instance = wrapper.instance();
...
describe('EmployerTable methods', () => {
    beforeEach(() => {
        jest.restoreAllMocks();
    });
    ...
    describe('getList', () => {
        it('fail', async () => {
            ...
            // setInitData will call after EmployerTable mount
            expect(getList.mock.calls[0][0]).toEqual('http://localhost/api/v1/employer/');
    ...
    describe('onSubmitSuccess', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(EmployerTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<EmployerTable list={list} />);
            instance = wrapper.instance();
        });
