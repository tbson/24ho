...
describe('FreelancerTable component', () => {
    beforeAll(() => {
        const response = {
            status: 200,
            success: true,
    ...
    it('Init data', done => {
        const wrapper = shallow(<FreelancerTable />);
    ...
    it('Check all', () => {
        ...
        jest.spyOn(FreelancerTable.prototype, 'componentDidMount').mockImplementation(() => {});

        const wrapper = shallow(<FreelancerTable list={seeding(10)} />);
        const instance = wrapper.instance();
...
describe('FreelancerTable methods', () => {
    beforeEach(() => {
        jest.restoreAllMocks();
    });
    ...
    describe('toggleModal', () => {
        ...
        beforeEach(() => {
            jest.spyOn(FreelancerTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<FreelancerTable />);
    ...
    describe('getList', () => {
        it('fail', async () => {
            ...
            // setInitData will call after FreelancerTable mount
            expect(getList.mock.calls[0][0]).toEqual('http://localhost/api/v1/freelancer/');
    ...
    describe('onSubmitSuccess', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(FreelancerTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<FreelancerTable list={list} />);
            instance = wrapper.instance();
        });
