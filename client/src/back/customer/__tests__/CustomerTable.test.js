...
describe('CustomerTable component', () => {
    ...
    it('Init data', done => {
        const wrapper = shallow(<CustomerTable />);
    ...
    it('Check all', () => {
        ...
        jest.spyOn(CustomerTable.prototype, 'componentDidMount').mockImplementation(() => {});

        const wrapper = shallow(<CustomerTable list={seeding(10)} />);
        const instance = wrapper.instance();
...
describe('CustomerTable methods', () => {
    beforeEach(() => {
        jest.restoreAllMocks();
    });
    ...
    describe('getList', () => {
        it('fail', async () => {
            ...
            // setInitData will call after CustomerTable mount
            expect(getList.mock.calls[0][0]).toEqual('http://localhost/api/v1/customer/');
    ...
    describe('onSubmitSuccess', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(CustomerTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<CustomerTable list={list} />);
            instance = wrapper.instance();
        });
