...
class FreelancerBaseSerializer(ModelSerializer):
...
class FreelancerCreateSerializer(FreelancerBaseSerializer):

    class Meta(FreelancerBaseSerializer.Meta):
        extra_kwargs = {
            'user': {'required': False},
        }
    ...
    def create(self, validated_data):
        ...
        return Freelancer.objects.create(user=user)


class FreelancerUpdateSerializer(FreelancerBaseSerializer):
