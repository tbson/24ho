    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cust_care', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cust_care', to='staff.Staff')),
                ('sale', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sale', to='staff.Staff')),
