...
from .serializers import EmployerCreateSerializer
...
class EmployerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.item0 = EmployerCreateSerializer(data=item0)
        self.item0.is_valid(raise_exception=True)
        self.item0.save()
        self.item0 = Employer.objects.get(user__username=self.item0.data["username"])

        self.item1 = EmployerCreateSerializer(data=item1)
        self.item1.is_valid(raise_exception=True)
        self.item1.save()
        self.item1 = Employer.objects.get(user__username=self.item1.data["username"])

        self.item2 = EmployerCreateSerializer(data=item2)
        self.item2.is_valid(raise_exception=True)
        self.item2.save()
        self.item2 = Employer.objects.get(user__username=self.item2.data["username"])

    def test_list(self):
        response = self.client.get(
            reverse("api_v1:employer:list"),
    ...
    def test_create(self):
        ...
        response = self.client.post(
            reverse("api_v1:employer:create"),
            json.dumps(dataFail),
        ...
        self.assertEqual(Employer.objects.count(), 5)
    ...
    def test_delete(self):
        ...
        self.assertEqual(response.status_code, 404)
        self.assertEqual(Employer.objects.count(), 4)
    ...
    def test_changePassword(self):
        ...
        response = self.client.post(
            reverse(
                "api_v1:employer:changePassword",
            ),
            json.dumps(data),
            content_type="application/json",
            Authorization="JWT " + self.token,
