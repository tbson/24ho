...
class EmployerBaseSerializer(ModelSerializer):
...
class EmployerCreateSerializer(EmployerBaseSerializer):

    class Meta(EmployerBaseSerializer.Meta):
        extra_kwargs = {
            'user': {'required': False},
        }
...
class EmployerUpdateSerializer(EmployerBaseSerializer):
